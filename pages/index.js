...
import RedesIconos from "../components/RedesIconos";


export default function Home() {
  const { mensaje, urlEnlace } = useAppContext();
  ...
  return (
    ...
    <div className="md:w-4/5 xl:w-3/5 px-5 mx-auto ">
      ...
      <div className="lg:flex lg:gap-5 md:shadow-lg bg-white rounded-lg py-10 px-5 shadow-md">
        {
          urlEnlace ?
          (<div className="text-center p-3 bg-red-50 mb-3 rounded-md shadow-sm grow flex flex-col items-center justify-center">
            <p className="font-bold text-red-700 text-2xl">
              👌Copia el enlace de tu archivo y compártelo!
              </p>
            ...
            <RedesIconos url={`${domain}enlaces/${urlEnlace}`} />
        ...
        <div className="lg:w-1/2">
          <h2 className="text-2xl text-center md:text-start lg:text-4xl font-sans font-bold text-gray-800 mb-3">Compartir archivos de forma sencilla y rápida</h2>
